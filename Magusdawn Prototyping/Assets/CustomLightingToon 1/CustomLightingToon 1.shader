...
Shader "MagusdawnToon"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_cast_3 = (( 0.5 * _AlbedoLevel )).xxxx;
			float4 clampResult184 = clamp( ( ase_lightColor * float4( ( indirectDiffuse11 + temp_output_151_0 ) , 0.0 ) * ( temp_output_151_0 + ( tex2D( _ShadowMap, uv_ShadowMap ) * _ShadowColor ) ) ) , float4( 0,0,0,0 ) , temp_cast_3 );
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float dotResult38 = dot( ase_worldNormal , ase_worldViewDir );
			c.rgb = ( ( ( tex2D( _Emission, uv_Emission ) * _EmissionColor ) + ( clampResult84 + ( ( tex2D( _Diffuse, uv_Diffuse ) * _MainColor ) * clampResult184 ) ) ) + ( saturate( ( ( ase_lightAtten * dotResult3 ) * pow( ( 1.0 - saturate( ( dotResult38 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * ase_lightColor ) ) ).rgb;
			c.a = 1;
...
/*ASEBEGIN
Version=15401
2065;87;1504;944;2397.284;960.5302;2.399565;True;False
Node;AmplifyShaderEditor.RangedFloatNode;92;-3577.918,186.6267;Float;False;Property;_NormalScale;NormalScale;13;0;Create;True;0;0;False;0;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;91;-3392.953,141.7988;Float;True;Property;_NormalMap;NormalMap;12;0;Create;True;0;0;False;0;None;4ef0ac462b6ac79428c11e77b7a01c14;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-1641.013,132.0357;Float;False;Property;_ShadowOffset;ShadowOffset;20;0;Create;True;0;0;False;0;-50;-64.54;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1661.836,39.56157;Float;False;Property;_ShadowSharpness;ShadowSharpness;19;0;Create;True;0;0;False;0;100;113.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-1437.757,-410.4154;Float;False;Property;_LightmapSharpness;LightmapSharpness;22;0;Create;True;0;0;False;0;0;80;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;144;-1443.891,-319.1866;Float;False;Property;_LightmapOffset;LightmapOffset;21;0;Create;True;0;0;False;0;-50;-54.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;169;-826.3178,368.8029;Float;False;540.2805;466.2345;Comment;3;57;100;99;Colour Shade;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;915.1548,-869.0199;Float;False;Property;_HighlightSharpness;HighlightSharpness;15;0;Create;True;0;0;False;0;100;60.47;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;945.7184,-779.5408;Float;False;Property;_HighlightOffset;HighlightOffset;16;0;Create;True;0;0;False;0;-80;-56.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;57;-744.5774,628.0375;Float;False;Property;_ShadowColor;ShadowColor;18;0;Create;True;0;0;False;0;0,0,0,0;0.8867924,0.8867924,0.8867924,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;1966.407,1094.001;Float;False;Property;_RimOffset;Rim Offset;5;0;Create;True;0;0;False;0;0.24;0.88;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;99;-776.3183,418.8028;Float;True;Property;_ShadowMap;ShadowMap;17;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;176;136.4948,44.19838;Float;False;606.4951;329.9142;Comment;4;12;11;10;8;Ambient and Light Colour;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;177;794.3138,136.4341;Float;False;759.9708;400.2018;Comment;4;87;88;89;184;Albedo Boost;1,1,1,1;0;0
Node;AmplifyShaderEditor.SaturateNode;151;-549.0538,-23.11972;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IndirectDiffuseLighting;11;135.0005,297.574;Float;False;Tangent;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;100;-455.038,571.1522;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;170;-218.3514,194.6182;Float;False;285;303;Comment;1;75;Add shade colour;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;844.3138,421.6361;Float;False;Property;_AlbedoLevel;AlbedoLevel;8;0;Create;True;0;0;False;0;1;1.28;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;12;395.9906,247.1124;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;75;-168.3517,248.6546;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;83;1659.127,-1060.3;Float;False;Property;_HighlightColor;HighlightColor;14;0;Create;True;0;0;False;0;0.3773585,0.3773585,0.3773585,0;1,1,0.2783019,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;89;1135.105,322.3125;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;43;1205.893,-347.6611;Float;True;Property;_Diffuse;Diffuse;7;0;Create;True;0;0;False;0;84508b93f15f2b64386ec07486afc7a3;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;533.8993,122.5935;Float;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;73;1199.589,-110.9206;Float;False;Property;_MainColor;MainColor;6;0;Create;True;0;0;False;0;1,1,1,0;0.9245283,0.9158805,0.8503916,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;34;2862.407,1094.001;Float;False;Property;_RimColor;Rim Color;3;1;[HDR];Create;True;0;0;False;0;0,1,0.8758622,0;0.4708319,0.4708319,0.4708319,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AD1271467FC36A1B9CCF84A68A67D973D1949E48